                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <button wire:click='deleteUser({{ $user->id }})'
                                ...
                                type="button" onclick="confirm('Yakin menghapus {{ $user->name }}')">
                                Hapus
                            </button>
                            ...
                            @php($modalTarget = "authentication-modal-" . $user->id)
                            @include('modal.action', ['user' => $user, 'modalTarget' => $modalTarget])
